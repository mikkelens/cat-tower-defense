...
namespace Scripts.Yarn
{
	...
	public class YarnOverrideLayer : YarnLayer
	{
		...
		public Optional<DamagePassthroughType> damagePassthroughTypeOverride; // always valid
		...
		public YarnValues ApplyOverridesToValues(YarnValues values)
		{
			...
			if (damagePassthroughTypeOverride.Enabled) values.damagePassthroughType = damagePassthroughTypeOverride.Value;
